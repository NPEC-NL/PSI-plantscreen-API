...
[**fc_imaging_extended_data**](FcApi.md#fc_imaging_extended_data) | **GET** /Fc/Imaging/ExtendedData | Returns FluorCam extended data for tray defined by tray ID, by round ID of round in which the tray was measured and by device defined by device ID.
[**fc_imaging_extended_data_measure**](FcApi.md#fc_imaging_extended_data_measure) | **GET** /Fc/Imaging/ExtendedData/Measure | Returns FluorCam imaging extended data by FC measure ID.
...
[**fc_param_used_analyse**](FcApi.md#fc_param_used_analyse) | **GET** /Fc/Param/Used/Analyse | Returns the FluorCam plant and leaf parameters used in the analysis defined by analyse ID.
