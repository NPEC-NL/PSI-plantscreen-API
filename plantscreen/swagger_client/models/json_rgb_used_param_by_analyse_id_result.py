...
class JsonRgbUsedParamByAnalyseIDResult(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JsonRgbUsedParamByAnalyseIDResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JsonRgbUsedParamByAnalyseIDResult):
            return False
