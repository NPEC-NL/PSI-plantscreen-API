...
class JsonRoundOrderByExperimentIDAndDateResult(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JsonRoundOrderByExperimentIDAndDateResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JsonRoundOrderByExperimentIDAndDateResult):
            return False
