...
class JsonMscMeasureExtendedDataResult(object):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(JsonMscMeasureExtendedDataResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JsonMscMeasureExtendedDataResult):
            return False
