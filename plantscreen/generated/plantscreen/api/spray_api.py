...
class SprayApi:
    ...
    def spray_action(
        ...
        _param = self._spray_action_serialize(
            device_id=device_id,
            round_id=round_id,
            tray_id=tray_id,
    ...
    @validate_call
    def spray_action_with_http_info(
        self,
        device_id: Annotated[StrictInt, Field(description="deviceID")],
        round_id: Annotated[StrictInt, Field(description="roundID")],
        tray_id: Annotated[StrictInt, Field(description="trayID")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonSprayActionResult]:
        """Return spray action data for tray defined by tray ID, by round ID of round in which the tray was measured and by device defined by device ID.
    ...
    @validate_call
    def spray_action_without_preload_content(
        self,
        device_id: Annotated[StrictInt, Field(description="deviceID")],
        round_id: Annotated[StrictInt, Field(description="roundID")],
        tray_id: Annotated[StrictInt, Field(description="trayID")],
