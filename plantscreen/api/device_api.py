...
class DeviceApi:
    ...
    def device(
        self,
        id: Annotated[StrictInt, Field(description="deviceID")],
    ...
    @validate_call
    def device_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="deviceID")],
        _request_timeout: Union[
            None,
    ...
    def device_active(
        ...
        _param = self._device_active_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def device_active_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonDeviceActiveResult]:
        """Returns all active devices that have not ended validity.
    ...
    @validate_call
    def device_active_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def device_profile(
        ...
        _param = self._device_profile_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "JsonDeviceByProfileIDResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def device_profile_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="profileID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonDeviceByProfileIDResult]:
        """Returns all devices that contains the system profile defined by ID.
    ...
    @validate_call
    def device_profile_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="profileID")],
        _request_timeout: Union[
            None,
