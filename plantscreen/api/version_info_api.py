...
class VersionInfoApi:
    ...
    def version_info(
        ...
        _param = self._version_info_serialize(
    ...
    @validate_call
    def version_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[JsonVersionInfoResult]:
        """Returns version of the database and the PlantScreen Data REST API used
    ...
    @validate_call
    def version_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
