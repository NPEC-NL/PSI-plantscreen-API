...
class JsonExperimentResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_experiment_result
        if self.json_experiment_result:
            _dict['JsonExperimentResult'] = self.json_experiment_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonExperimentResult": Experiment.from_dict(obj["JsonExperimentResult"]) if obj.get("JsonExperimentResult") is not None else None
        })
        return _obj
