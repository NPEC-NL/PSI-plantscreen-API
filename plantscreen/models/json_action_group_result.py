...
class JsonActionGroupResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_action_group_result
        if self.json_action_group_result:
            _dict['JsonActionGroupResult'] = self.json_action_group_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonActionGroupResult": ActionGroup.from_dict(obj["JsonActionGroupResult"]) if obj.get("JsonActionGroupResult") is not None else None
        })
        return _obj
