...
class JsonSystemProfileActiveResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_system_profile_active_result
        if self.json_system_profile_active_result:
            _dict['JsonSystemProfileActiveResult'] = self.json_system_profile_active_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonSystemProfileActiveResult": SystemProfile.from_dict(obj["JsonSystemProfileActiveResult"]) if obj.get("JsonSystemProfileActiveResult") is not None else None
        })
        return _obj
