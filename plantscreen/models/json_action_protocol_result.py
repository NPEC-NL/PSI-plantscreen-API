...
class JsonActionProtocolResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_action_protocol_result
        if self.json_action_protocol_result:
            _dict['JsonActionProtocolResult'] = self.json_action_protocol_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonActionProtocolResult": ActionProtocol.from_dict(obj["JsonActionProtocolResult"]) if obj.get("JsonActionProtocolResult") is not None else None
        })
        return _obj
