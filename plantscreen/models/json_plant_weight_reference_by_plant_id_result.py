...
class JsonPlantWeightReferenceByPlantIDResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_plant_weight_reference_by_plant_id_result
        if self.json_plant_weight_reference_by_plant_id_result:
            _dict['JsonPlantWeightReferenceByPlantIDResult'] = self.json_plant_weight_reference_by_plant_id_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonPlantWeightReferenceByPlantIDResult": PlantWeightReference.from_dict(obj["JsonPlantWeightReferenceByPlantIDResult"]) if obj.get("JsonPlantWeightReferenceByPlantIDResult") is not None else None
        })
        return _obj
