...
class MscCalibrationLight(BaseModel):
    ...
    calibration_light_id: Optional[StrictInt] = Field(default=None, alias="CalibrationLightID")
    calibration_light_level: Optional[StrictInt] = Field(default=None, alias="CalibrationLightLevel")
