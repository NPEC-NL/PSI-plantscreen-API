...
class JsonMscCalibrationByLightSetIDResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_msc_calibration_by_light_set_id_result
        if self.json_msc_calibration_by_light_set_id_result:
            _dict['JsonMscCalibrationByLightSetIDResult'] = self.json_msc_calibration_by_light_set_id_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonMscCalibrationByLightSetIDResult": MscCalibration.from_dict(obj["JsonMscCalibrationByLightSetIDResult"]) if obj.get("JsonMscCalibrationByLightSetIDResult") is not None else None
        })
        return _obj
