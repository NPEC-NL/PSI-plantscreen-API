...
class SpectrumDevice(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of spectrum_device_wavelengths_json
        if self.spectrum_device_wavelengths_json:
            _dict['SpectrumDeviceWavelengthsJSON'] = self.spectrum_device_wavelengths_json.to_dict()
        return _dict
