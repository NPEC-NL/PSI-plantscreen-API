...
class JsonScalesMeasureByIDResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_scales_measure_by_id_result
        if self.json_scales_measure_by_id_result:
            _dict['JsonScalesMeasureByIDResult'] = self.json_scales_measure_by_id_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonScalesMeasureByIDResult": ScalesData.from_dict(obj["JsonScalesMeasureByIDResult"]) if obj.get("JsonScalesMeasureByIDResult") is not None else None
        })
        return _obj
