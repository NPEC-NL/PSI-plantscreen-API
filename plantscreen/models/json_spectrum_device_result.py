...
class JsonSpectrumDeviceResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_spectrum_device_result
        if self.json_spectrum_device_result:
            _dict['JsonSpectrumDeviceResult'] = self.json_spectrum_device_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonSpectrumDeviceResult": SpectrumDevice.from_dict(obj["JsonSpectrumDeviceResult"]) if obj.get("JsonSpectrumDeviceResult") is not None else None
        })
        return _obj
