...
class JsonRgbGreeningMaskImageByMeasureIDResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_rgb_greening_mask_image_by_measure_id_result
        if self.json_rgb_greening_mask_image_by_measure_id_result:
            _dict['JsonRgbGreeningMaskImageByMeasureIDResult'] = self.json_rgb_greening_mask_image_by_measure_id_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonRgbGreeningMaskImageByMeasureIDResult": RgbGreeningMaskImage.from_dict(obj["JsonRgbGreeningMaskImageByMeasureIDResult"]) if obj.get("JsonRgbGreeningMaskImageByMeasureIDResult") is not None else None
        })
        return _obj
