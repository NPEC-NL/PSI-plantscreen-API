...
class JsonProbeResult(BaseModel):
    """
    JsonProbeResult
    """ # noqa: E501
    ...
    @property
    def result(self) -> List[Probe]:
        return self.json_probe_result
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in json_probe_result (list)
        _items = []
        if self.json_probe_result:
            for _item_json_probe_result in self.json_probe_result:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonProbeResult": [Probe.from_dict(_item) for _item in obj["JsonProbeResult"]] if obj.get("JsonProbeResult") is not None else None
        })
        return _obj
