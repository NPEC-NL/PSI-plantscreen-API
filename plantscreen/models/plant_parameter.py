...
class PlantParameter(BaseModel):
    """
    PlantParameter
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["AnalyseID", "DeviceID", "DevicePID", "ExperimentID", "MeasureAngle", "MeasureID", "ParameterID", "ParameterName", "ParameterValue", "PlantBarcode", "PlantID", "PlantName", "RoundID", "TrayArea", "TrayBarcode", "TrayID"]
