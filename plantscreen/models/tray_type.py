...
class TrayType(BaseModel):
    ...
    type_mask_bottom: Optional[StrictStr] = Field(default=None, alias="TypeMaskBottom")
    type_mask_side: Optional[StrictStr] = Field(default=None, alias="TypeMaskSide")
    type_mask_top: Optional[StrictStr] = Field(default=None, alias="TypeMaskTop")
    type_mask_under_side: Optional[StrictStr] = Field(default=None, alias="TypeMaskUnderSide")
