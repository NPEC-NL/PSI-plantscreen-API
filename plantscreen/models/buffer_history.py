...
class BufferHistory(BaseModel):
    ...
    BufferHistory
    """ # noqa: E501
    buffer_occasion: Optional[StrictStr] = Field(default=None, alias="BufferOccasion")
    ...
    @field_validator('buffer_state_date')
    def buffer_state_date_validate_regular_expression(cls, value):
