...
class JsonMscLightSetResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_msc_light_set_result
        if self.json_msc_light_set_result:
            _dict['JsonMscLightSetResult'] = self.json_msc_light_set_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonMscLightSetResult": MscLightSet.from_dict(obj["JsonMscLightSetResult"]) if obj.get("JsonMscLightSetResult") is not None else None
        })
        return _obj
