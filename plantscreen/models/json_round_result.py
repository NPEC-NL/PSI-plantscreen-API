...
class JsonRoundResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of json_round_result
        if self.json_round_result:
            _dict['JsonRoundResult'] = self.json_round_result.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JsonRoundResult": Round.from_dict(obj["JsonRoundResult"]) if obj.get("JsonRoundResult") is not None else None
        })
        return _obj
