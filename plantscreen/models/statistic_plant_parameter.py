...
class StatisticPlantParameter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["AnalyseID", "DeviceID", "DevicePID", "ExperimentID", "MeasureAngle", "MeasureID", "ParameterAvg", "ParameterID", "ParameterMax", "ParameterMedian", "ParameterMin", "ParameterName", "ParameterStddev", "PlantBarcode", "PlantID", "PlantName", "RoundID", "TrayArea", "TrayBarcode", "TrayID"]
