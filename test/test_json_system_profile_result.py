...
class TestJsonSystemProfileResult(unittest.TestCase):
    """JsonSystemProfileResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonSystemProfileResult:
        """Test JsonSystemProfileResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonSystemProfileResult`
        """
        model = JsonSystemProfileResult()
        if include_optional:
            return JsonSystemProfileResult(
                json_system_profile_result = plantscreen.models.system_profile.SystemProfile(
                    profile_active = True, 
                    profile_id = 56, 
                    profile_info = '', 
                    profile_name = '', 
    ...
    def testJsonSystemProfileResult(self):
        """Test JsonSystemProfileResult"""
